...
Call PutVar("CLASS", "Name", frmclasseseditor.nom.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "MaleSprite", frmclasseseditor.scrlhom.value, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "FemaleSprite", frmclasseseditor.scrlfem.value, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "STR", Val(frmclasseseditor.force.text), App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "DEF", frmclasseseditor.def.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "SPEED", frmclasseseditor.vit.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "MAGI", frmclasseseditor.magi.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "MAP", frmclasseseditor.carted.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "X", Val(frmclasseseditor.xd.text), App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "Y", frmclasseseditor.yd.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("STARTUP", "Weapon", frmclasseseditor.arme.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("STARTUP", "Shield", frmclasseseditor.bouclier.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("STARTUP", "Armor", frmclasseseditor.armure.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("STARTUP", "Helmet", frmclasseseditor.caske.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASSCHANGE", "AddStr", frmclasseseditor.ajf.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASSCHANGE", "AddDef", Val(frmclasseseditor.ajd.text), App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASSCHANGE", "AddSpeed", frmclasseseditor.ajv.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASSCHANGE", "AddMagi", frmclasseseditor.ajm.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("DEATH", "Map", frmclasseseditor.cartem.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("DEATH", "x", frmclasseseditor.xm.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("DEATH", "y", frmclasseseditor.ym.text, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Call PutVar("CLASS", "Locked", frmclasseseditor.lock.value, App.Path & "\Classes\Class" & frmclasseseditor.Tag & ".ini")
Me.Hide
End Sub
