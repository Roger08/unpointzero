   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.PictureBox picWeather 
         ...
         Begin VB.CommandButton CommandMeteoMap 
            Caption         =   "Désactiver la météo par map"
            Height          =   255
            Left            =   240
            TabIndex        =   164
            Top             =   1080
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Label Label13 
            Caption         =   "Ratio d'expérience quête : 1"
            Height          =   255
            Left            =   240
            TabIndex        =   170
            Top             =   840
...
End If
    ...
    If Scripting = 1 Then
        frmServer.lblscript.Caption = "Etat : activé"
        frmServer.lblscript.ForeColor = RGB(51, 204, 0)
    Else
        frmServer.lblscript.Caption = "Etat : désactivé"
...
If Scripting = 1 Then
    ...
    End If
End If
Call IBMsg("Les scripts sont désactivés.")
If Scripting = 1 Then
        frmServer.lblscript.Caption = "Etat : activé"
        frmServer.lblscript.ForeColor = RGB(51, 204, 0)
    Else
...
If Scripting = 0 Then
    ...
    End If
End If
Call IBMsg("Les scripts sont activés.")
If Scripting = 1 Then
        frmServer.lblscript.Caption = "Etat : activé"
        frmServer.lblscript.ForeColor = RGB(51, 204, 0)
    Else
...
Dim O As Long
    ...
    O = Val(z)
    frmclasseseditor.nom.text = GetVar("CLASS", "Name", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.scrlhom.value = Val(GetVar("CLASS", "MaleSprite", App.Path & "\Classes\Class" & O & ".ini"))
    frmclasseseditor.scrlfem.value = Val(GetVar("CLASS", "FemaleSprite", App.Path & "\Classes\Class" & O & ".ini"))
    ...
    frmclasseseditor.force.text = GetVar("CLASS", "STR", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.def.text = GetVar("CLASS", "DEF", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.vit.text = GetVar("CLASS", "SPEED", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.magi.text = GetVar("CLASS", "MAGI", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.carted.text = GetVar("CLASS", "MAP", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.xd.text = GetVar("CLASS", "X", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.yd.text = GetVar("CLASS", "Y", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.arme.text = GetVar("STARTUP", "Weapon", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.bouclier.text = GetVar("STARTUP", "Shield", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.armure.text = GetVar("STARTUP", "Armor", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.caske.text = GetVar("STARTUP", "Helmet", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.ajf.text = GetVar("CLASSCHANGE", "AddStr", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.ajd.text = GetVar("CLASSCHANGE", "AddDef", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.ajv.text = GetVar("CLASSCHANGE", "AddSpeed", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.ajm.text = GetVar("CLASSCHANGE", "AddMagi", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.cartem.text = GetVar("DEATH", "Map", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.xm.text = GetVar("DEATH", "x", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.ym.text = GetVar("DEATH", "y", App.Path & "\Classes\Class" & O & ".ini")
    frmclasseseditor.lock.value = Val(GetVar("CLASS", "Locked", App.Path & "\Classes\Class" & O & ".ini"))
...
Index = MapList.ListIndex + 1
    ...
    frmInfosMap.MapInfo(1).Caption = "Révision: " & Map(Index).Revision
    ...
    frmInfosMap.MapInfo(8).Caption = "Carte de départ: " & Map(Index).BootMap
    frmInfosMap.MapInfo(9).Caption = "Départ des X: " & Map(Index).BootX
    frmInfosMap.MapInfo(10).Caption = "Départ des Y: " & Map(Index).BootY
    frmInfosMap.MapInfo(11).Caption = "Magasin: " & Map(Index).Shop
    frmInfosMap.MapInfo(12).Caption = "Intérieur: " & Map(Index).Indoors
...
If txtExp.text >= 0 And txtExp.text <= 1000000 Then
    ...
    Next Index
Else
    Call MsgBox("Merci de spécifier une valeur entre 1 et 1 000 000")
End If
...
Private Sub Command59_Click()
    ...
    Else
        ...
        frmServer.Label5.Caption = "Temps actuel : Météo par map"
    End If
...
Label7.Caption = "Ratio d'expérience normal : " & HScroll1.value
Command13.Enabled = True
End Sub

Private Sub HScroll2_Change()
Label13.Caption = "Ratio d'expérience quête : " & HScroll2.value
Command13.Enabled = True
End Sub
